(function() {
    ...
    if (!overlay) {
        ...
        overlay.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;z-index:-49;pointer-events:none;background:rgba(8,6,18,0.85);';
    ...
    // Fragment shader source code (from Stitch shader-background.tsx)
    const fsSource = `
      ...
      void main() {
        ...
        vec4 lines = vec4(0.0);
        vec4 bgColor1 = vec4(0.06, 0.04, 0.15, 1.0); // Deeper dark purple matching brand style
        vec4 bgColor2 = vec4(0.08, 0.05, 0.22, 1.0);
